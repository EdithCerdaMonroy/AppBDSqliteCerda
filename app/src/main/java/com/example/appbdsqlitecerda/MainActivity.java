...
public class MainActivity extends AppCompatActivity {
    ...
    public Button btnAbrirListaProd, btnAudioVideo2;
...
//integracion de xml a java
        ...
        btnAudioVideo2=findViewById(R.id.btnAudioVideo2);
        btnAudioVideo2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent abrirVentana=new Intent(view.getContext(),AudioVideo.class);
